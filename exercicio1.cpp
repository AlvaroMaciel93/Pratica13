...
int main() {
    ...
    viagens[0].passagens.push_back(Passagem(1, "10/08/2023", 2, "09871234567", "Jorge", 30, 80.0));
    viagens[0].passagens.push_back(Passagem(2, "14/08/2023", 2, "98765432109", "Malu", 25, 80.0));
    viagens[0].passagens.push_back(Passagem(3, "15/09/2023", 2, "12345678901", "Murilo", 35, 80.0));
